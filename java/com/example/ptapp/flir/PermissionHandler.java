...
import com.example.ptapp.ThermalCamera;
...
public class PermissionHandler {
    ...
    private final ThermalCamera mainActivity;

    DetailsActivity.ShowMessage showMessage;
    ...
    public PermissionHandler(DetailsActivity.ShowMessage showMessage, ThermalCamera mainActivity) {
    ...
    private boolean checkPermission(final String permission){
        ...
        int checkPermission = mainActivity.checkPermission(permission, Process.myPid(), Process.myUid());
